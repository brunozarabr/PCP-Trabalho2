...
for intervalo_x in intervalo_x_values:
    ...
    plt.title(f'Distribuição dos Tempos de Execução para intervalo_x = {intervalo_x} (escala linear)')
    ...
    plt.savefig(f"histograma_tempos_execucao_intervalo_x_{intervalo_x}_normal.png")
    plt.show()
